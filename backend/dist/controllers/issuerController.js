...
export const issuerController = {
     ...
     */
    async resolveIssuer(req, res, next) {
        try {
     ...
     */
    async resolveAllIssuers(req, res, next) {
        try {
    ...
    async verifySignature(req, res, next) {
        try {
            ...
            const isValid = await issuerResolverService.verifyCredentialSignature(did, signature);
            res.json({
                success: true,
...
//# sourceMappingURL=issuerController.js.map