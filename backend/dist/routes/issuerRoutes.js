 ...
 * @access  Public
 */
router.post('/resolve', optionalAuth, [body('did').isString().withMessage('DID is required')], issuerController.resolveIssuer);
/**
 ...
 * @access  Public
 */
router.post('/verify-signature', optionalAuth, [
...
//# sourceMappingURL=issuerRoutes.js.map