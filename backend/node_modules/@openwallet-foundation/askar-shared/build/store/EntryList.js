...
class EntryList {
    constructor({ handle, length }) {
        this._length = 0;
        this._handle = handle;
        this._length = length !== null && length !== void 0 ? length : askar_1.NativeAskar.instance.entryListCount({ entryListHandle: handle });
    }
    get handle() {
        return this._handle;
    }
