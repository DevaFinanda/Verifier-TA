...
export declare class Store {
    ...
    renameProfile({ fromProfile, toProfile }: {
        fromProfile: string;
        toProfile: string;
    }): Promise<number>;
    listOpenSessions(): Promise<import("../crypto").SessionHandle[]>;
    listOpenScans(): Promise<import("../crypto").ScanHandle[]>;
    copyProfile({ toStore, fromProfile, toProfile, }: {
        toStore: Store;
        fromProfile: string;
        toProfile: string;
    }): Promise<void>;
