import type { AeadParams, EncryptedBuffer, EntryListHandle, Jwk, Key, KeyEntryListHandle, LocalKeyHandle, ScanHandle, SessionHandle, StoreHandle } from '../crypto';
import type { KeyAlgorithm, KeyBackend, LogLevel, SignatureAlgorithm } from '../enums';
import type { AskarErrorObject } from '../error';
export type ErrorCode = number;
export type NativeLogCallback = (context: unknown, level: number, target: string, message: string, modulePath: string, file: string, line: number) => void;
...
export type SetMaxLogLevelOptions = {
    logLevel: number;
};
...
export type EntryListCountOptions = {
    entryListHandle: EntryListHandle;
};
export type EntryListFreeOptions = {
    entryListHandle: EntryListHandle;
};
...
export type KeyAeadGetParamsOptions = {
    localKeyHandle: LocalKeyHandle;
};
export type KeyAeadRandomNonceOptions = {
    localKeyHandle: LocalKeyHandle;
};
...
export type KeyFreeOptions = {
    localKeyHandle: LocalKeyHandle;
};
export type KeyFromJwkOptions = {
    jwk: Jwk;
};
...
export type KeyGetAlgorithmOptions = {
    localKeyHandle: LocalKeyHandle;
};
export type KeyGetEphemeralOptions = {
    localKeyHandle: LocalKeyHandle;
};
...
export type KeyGetJwkSecretOptions = {
    localKeyHandle: LocalKeyHandle;
};
...
export type KeyGetPublicBytesOptions = {
    localKeyHandle: LocalKeyHandle;
};
export type KeyGetSecretBytesOptions = {
    localKeyHandle: LocalKeyHandle;
};
...
export type ScanFreeOptions = {
    scanHandle: ScanHandle;
};
export type ScanNextOptions = {
    scanHandle: ScanHandle;
};
...
export type StoreGenerateRawKeyOptions = {
    seed?: Uint8Array;
};
export type StoreGetProfileNameOptions = {
    storeHandle: StoreHandle;
};
export type StoreGetDefaultProfileOptions = {
    storeHandle: StoreHandle;
};
export type StoreListProfilesOptions = {
    storeHandle: StoreHandle;
};
export type StoreListScansOptions = {
    storeHandle: StoreHandle;
};
export type StoreListSessionsOptions = {
    storeHandle: StoreHandle;
};
...
export type StoreRemoveOptions = {
    specUri: string;
};
