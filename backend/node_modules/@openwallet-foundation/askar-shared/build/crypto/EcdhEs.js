...
class EcdhEs {
    ...
    deriveKey({ encryptionAlgorithm, ephemeralKey, recipientKey, receive, }) {
        return new Key_1.Key(askar_1.NativeAskar.instance.keyDeriveEcdhEs({
            algId: this.algId,
            receive,
            apv: this.apv,
            apu: this.apu,
