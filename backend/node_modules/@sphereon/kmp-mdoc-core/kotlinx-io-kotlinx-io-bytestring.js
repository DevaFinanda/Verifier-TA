(function (factory) {
  ...
  var _UByte___init__impl__g9hnc4 = kotlin_kotlin.$_$.j2;
  var _UByte___get_data__impl__jof9qr = kotlin_kotlin.$_$.k2;
  ...
  var numberToInt = kotlin_kotlin.$_$.ta;
  var arrayCopy = kotlin_kotlin.$_$.e5;
  ...
  function Companion() {
    ...
    this.n2e_1 = new ByteString(new Int8Array(0), null);
    this.o2e_1 = toCharArray('0123456789abcdef');
  }
  protoOf(Companion).p2e = function (byteArray) {
  ...
  protoOf(ByteString).equals = function (other) {
    ...
    if (!(other instanceof ByteString))
      THROW_CCE();
    if (!(other.q2e_1.length === this.q2e_1.length))
      return false;
    if (!(other.r2e_1 === 0) && !(this.r2e_1 === 0) && !(other.r2e_1 === this.r2e_1))
      return false;
    return contentEquals(this.q2e_1, other.q2e_1);
  };
  protoOf(ByteString).hashCode = function () {
    var hc = this.r2e_1;
    if (hc === 0) {
      hc = contentHashCode(this.q2e_1);
      this.r2e_1 = hc;
    }
    return hc;
  };
  protoOf(ByteString).s2e = function (startIndex, endIndex) {
    ...
    return copyOfRange(this.q2e_1, startIndex, endIndex);
  };
  protoOf(ByteString).t2e = function (startIndex, endIndex, $super) {
    startIndex = startIndex === VOID ? 0 : startIndex;
    endIndex = endIndex === VOID ? this.t() : endIndex;
    return $super === VOID ? this.s2e(startIndex, endIndex) : $super.s2e.call(this, startIndex, endIndex);
  };
  protoOf(ByteString).u2e = function (other) {
    if (other === this)
      return 0;
    var localData = this.q2e_1;
    var otherData = other.q2e_1;
  ...
  protoOf(ByteString).d = function (other) {
    return this.u2e(other instanceof ByteString ? other : THROW_CCE());
  };
  protoOf(ByteString).toString = function () {
    ...
    $this$with.v8('ByteString(size=');
    $this$with.v8(sizeStr);
    $this$with.v8(' hex=');
    var localData = this.q2e_1;
    var inductionVariable = 0;
    var last = this.t();
    if (inductionVariable < last)
      do {
        ...
        inductionVariable = inductionVariable + 1 | 0;
        var b = localData[i];
        $this$with.w8(Companion_getInstance().o2e_1[(b >>> 4 | 0) & 15]);
        $this$with.w8(Companion_getInstance().o2e_1[b & 15]);
      }
       while (inductionVariable < last);
    return $this$with.w8(_Char___init__impl__6a9atx(41)).toString();
  };
  function EmptyByteString() {
    return Companion_getInstance().n2e_1;
  }
  ...
  function ensureCapacity($this, requiredCapacity) {
    ...
    if ($this.v2e_1.length === 0) {
      tmp = 16;
    } else {
      tmp = numberToInt($this.v2e_1.length * 1.5);
    }
    var desiredSize = tmp;
    ...
    $this.v2e_1 = newBuffer;
  }
  function ByteStringBuilder(initialCapacity) {
    initialCapacity = initialCapacity === VOID ? 0 : initialCapacity;
    this.v2e_1 = new Int8Array(initialCapacity);
    this.w2e_1 = 0;
  }
  protoOf(ByteStringBuilder).t = function () {
    return this.w2e_1;
  };
  protoOf(ByteStringBuilder).x2e = function () {
    if (this.t() === 0) {
      return EmptyByteString();
    }
    if (this.v2e_1.length === this.t()) {
      return Companion_getInstance().p2e(this.v2e_1);
    }
    return ByteString_init_$Create$(this.v2e_1, 0, this.t());
  };
  protoOf(ByteStringBuilder).y2e = function (byte) {
    ensureCapacity(this, this.t() + 1 | 0);
    var tmp = this.v2e_1;
    var _unary__edvuaz = this.w2e_1;
    this.w2e_1 = _unary__edvuaz + 1 | 0;
    tmp[_unary__edvuaz] = byte;
  };
  protoOf(ByteStringBuilder).z2e = function (array, startIndex, endIndex) {
    // Inline function 'kotlin.require' call
    if (!(startIndex <= endIndex)) {
    ...
    ensureCapacity(this, (this.w2e_1 + endIndex | 0) - startIndex | 0);
    var tmp2 = this.v2e_1;
    // Inline function 'kotlin.collections.copyInto' call
    var destinationOffset = this.w2e_1;
    // Inline function 'kotlin.js.unsafeCast' call
    // Inline function 'kotlin.js.asDynamic' call
    var tmp = array;
    // Inline function 'kotlin.js.unsafeCast' call
    // Inline function 'kotlin.js.asDynamic' call
    arrayCopy(tmp, tmp2, destinationOffset, startIndex, endIndex);
    this.w2e_1 = this.w2e_1 + (endIndex - startIndex | 0) | 0;
  };
  protoOf(ByteStringBuilder).a2f = function (array, startIndex, endIndex, $super) {
    startIndex = startIndex === VOID ? 0 : startIndex;
    endIndex = endIndex === VOID ? array.length : endIndex;
    var tmp;
    if ($super === VOID) {
      this.z2e(array, startIndex, endIndex);
      tmp = Unit_instance;
    } else {
      tmp = $super.z2e.call(this, array, startIndex, endIndex);
    }
    return tmp;
  };
