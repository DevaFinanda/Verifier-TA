(function (factory) {
  ...
  var CONTEXTUAL_getInstance = kotlin_org_jetbrains_kotlinx_kotlinx_serialization_core.$_$.k;
  ...
  var InlineClassDescriptor = kotlin_org_jetbrains_kotlinx_kotlinx_serialization_core.$_$.z1;
  ...
  var ByteArraySerializer_getInstance = kotlin_org_jetbrains_kotlinx_kotlinx_serialization_core.$_$.r;
  ...
  var NothingSerializer = kotlin_org_jetbrains_kotlinx_kotlinx_serialization_core.$_$.y;
  var getKClass = kotlin_kotlin.$_$.e;
  var ContextualSerializer = kotlin_org_jetbrains_kotlinx_kotlinx_serialization_core.$_$.p2;
  //endregion
  ...
  function AlgorithmIdentifierSerializer$descriptor$lambda($this$buildSerialDescriptor) {
    $this$buildSerialDescriptor.qo('algorithm', Companion_instance.c1t().xn());
    $this$buildSerialDescriptor.qo('parameters', buildSerialDescriptor('Any', CONTEXTUAL_getInstance(), []));
    return Unit_instance;
  }
  function AlgorithmIdentifierSerializer() {
    var tmp = this;
    var tmp_0 = OPEN_getInstance();
    tmp.b2x_1 = buildSerialDescriptor('AlgorithmIdentifier', tmp_0, [], AlgorithmIdentifierSerializer$descriptor$lambda);
  }
  protoOf(AlgorithmIdentifierSerializer).e2x = function (_this__u8e3s4, serializer, value) {
    _this__u8e3s4.zs(this.b2x_1, 1, serializer, value);
  };
  protoOf(AlgorithmIdentifierSerializer).f2x = function (_this__u8e3s4, serializer) {
    return _this__u8e3s4.wr(this.b2x_1, 1, serializer);
  };
  protoOf(AlgorithmIdentifierSerializer).xn = function () {
    return this.b2x_1;
  };
  protoOf(AlgorithmIdentifierSerializer).g2x = function (encoder, value) {
    var descriptor = this.b2x_1;
    var composite = encoder.hr(descriptor);
    ...
    composite.ys(this.b2x_1, 0, Companion_instance.c1t(), new ObjectIdentifier(value.a2x()));
    this.c2x(composite, value);
    composite.ir(descriptor);
    return Unit_instance;
  };
  protoOf(AlgorithmIdentifierSerializer).ko = function (encoder, value) {
    return this.g2x(encoder, (!(value == null) ? isInterface(value, AlgorithmIdentifier) : false) ? value : THROW_CCE());
  };
  protoOf(AlgorithmIdentifierSerializer).lo = function (decoder) {
    // Inline function 'kotlinx.serialization.encoding.decodeStructure' call
    var descriptor = this.b2x_1;
    var composite = decoder.hr(descriptor);
    ...
    if (!(composite.yr(this.b2x_1) === 0)) {
      throw IllegalStateException_init_$Create$('Check failed.');
    }
    var algorithm = composite.ur(this.b2x_1, 0, Companion_instance.c1t()).w2v_1;
    // Inline function 'kotlin.check' call
    if (!(composite.yr(this.b2x_1) === 1)) {
      throw IllegalStateException_init_$Create$('Check failed.');
    }
    var parameters = this.d2x(composite, algorithm);
    // Inline function 'kotlin.check' call
    if (!(composite.yr(this.b2x_1) === -1)) {
      throw IllegalStateException_init_$Create$('Check failed.');
    }
  ...
  protoOf(EcKeyAlgorithmIdentifier).a2x = function () {
  ...
  function $serializer() {
    ...
    tmp0_serialDesc.uy('namedCurve', false);
    this.i2x_1 = tmp0_serialDesc;
  }
  protoOf($serializer).j2x = function (encoder, value) {
    var tmp0_inlineEncoder = encoder.ns(this.i2x_1);
    if (tmp0_inlineEncoder == null)
      null;
    else {
      tmp0_inlineEncoder.jo($serializer_getInstance(), new ObjectIdentifier(_EcParameters___get_namedCurve__impl__oibidm(value)));
    }
  };
  protoOf($serializer).ko = function (encoder, value) {
    return this.j2x(encoder, value instanceof EcParameters ? value.k2x_1 : THROW_CCE());
  };
  protoOf($serializer).l2x = function (decoder) {
    return _EcParameters___init__impl__i4ww9z(decoder.fr(this.i2x_1).mo($serializer_getInstance()).w2v_1);
  };
  protoOf($serializer).lo = function (decoder) {
    return new EcParameters(this.l2x(decoder));
  };
  ...
  function EcParameters__equals_impl_5tm4e2($this, other) {
    if (!(other instanceof EcParameters))
      return false;
    if (!($this === (other instanceof EcParameters ? other.k2x_1 : THROW_CCE())))
      return false;
    return true;
  }
  function EcParameters(namedCurve) {
    this.k2x_1 = namedCurve;
  }
  protoOf(EcParameters).toString = function () {
    return EcParameters__toString_impl_mgxjuh(this.k2x_1);
  };
  protoOf(EcParameters).hashCode = function () {
    return EcParameters__hashCode_impl_prn1m(this.k2x_1);
  };
  protoOf(EcParameters).equals = function (other) {
    return EcParameters__equals_impl_5tm4e2(this.k2x_1, other);
  };
  ...
  function $serializer_0() {
    ...
    tmp0_serialDesc.uy('privateKey', false);
    tmp0_serialDesc.uy('parameters', true);
    tmp0_serialDesc.vy(new ContextSpecificTag(0, TagType_EXPLICIT_getInstance()));
    tmp0_serialDesc.uy('publicKey', true);
    tmp0_serialDesc.vy(new ContextSpecificTag(1, TagType_EXPLICIT_getInstance()));
    this.m2x_1 = tmp0_serialDesc;
  }
  protoOf($serializer_0).n2x = function (encoder, value) {
    var tmp0_desc = this.m2x_1;
    var tmp1_output = encoder.hr(tmp0_desc);
    tmp1_output.rs(tmp0_desc, 0, value.o2x_1);
    tmp1_output.ys(tmp0_desc, 1, ByteArraySerializer_getInstance(), value.p2x_1);
    var tmp;
    if (tmp1_output.dt(tmp0_desc, 2)) {
      tmp = true;
    } else {
      var tmp_0 = value.q2x_1;
      tmp = !((tmp_0 == null ? null : new EcParameters(tmp_0)) == null);
    }
    if (tmp) {
      var tmp_1 = $serializer_getInstance_1();
      var tmp_2 = value.q2x_1;
      tmp1_output.zs(tmp0_desc, 2, tmp_1, tmp_2 == null ? null : new EcParameters(tmp_2));
    }
    if (tmp1_output.dt(tmp0_desc, 3) ? true : !(value.r2x_1 == null)) {
      tmp1_output.zs(tmp0_desc, 3, $serializer_getInstance_0(), value.r2x_1);
    }
    tmp1_output.ir(tmp0_desc);
  };
  protoOf($serializer_0).ko = function (encoder, value) {
    return this.n2x(encoder, value instanceof EcPrivateKey ? value : THROW_CCE());
  };
  protoOf($serializer_0).lo = function (decoder) {
    var tmp0_desc = this.m2x_1;
    var tmp1_flag = true;
    var tmp2_index = 0;
    var tmp3_bitMask0 = 0;
    ...
    var tmp8_input = decoder.hr(tmp0_desc);
    if (tmp8_input.xr()) {
      tmp4_local0 = tmp8_input.mr(tmp0_desc, 0);
      tmp3_bitMask0 = tmp3_bitMask0 | 1;
      tmp5_local1 = tmp8_input.tr(tmp0_desc, 1, ByteArraySerializer_getInstance(), tmp5_local1);
      tmp3_bitMask0 = tmp3_bitMask0 | 2;
      var tmp = $serializer_getInstance_1();
      var tmp_0 = tmp6_local2;
      var tmp_1 = tmp8_input.vr(tmp0_desc, 2, tmp, tmp_0 == null ? null : new EcParameters(tmp_0));
      tmp6_local2 = tmp_1 == null ? null : tmp_1.k2x_1;
      tmp3_bitMask0 = tmp3_bitMask0 | 4;
      tmp7_local3 = tmp8_input.vr(tmp0_desc, 3, $serializer_getInstance_0(), tmp7_local3);
      tmp3_bitMask0 = tmp3_bitMask0 | 8;
    } else
      while (tmp1_flag) {
        tmp2_index = tmp8_input.yr(tmp0_desc);
        switch (tmp2_index) {
          case -1:
            tmp1_flag = false;
            break;
          ...
          case 2:
            ...
            var tmp_4 = tmp8_input.vr(tmp0_desc, 2, tmp_2, tmp_3 == null ? null : new EcParameters(tmp_3));
            tmp6_local2 = tmp_4 == null ? null : tmp_4.k2x_1;
            tmp3_bitMask0 = tmp3_bitMask0 | 4;
            break;
          case 3:
            tmp7_local3 = tmp8_input.vr(tmp0_desc, 3, $serializer_getInstance_0(), tmp7_local3);
  ...
  function EcPrivateKey_init_$Init$(seen0, version, privateKey, parameters, publicKey, serializationConstructorMarker, $this) {
    if (!(3 === (3 & seen0))) {
      throwMissingFieldException(seen0, 3, $serializer_getInstance_2().m2x_1);
    }
    $this.o2x_1 = version;
    $this.p2x_1 = privateKey;
    if (0 === (seen0 & 4))
      $this.q2x_1 = null;
    else
      $this.q2x_1 = parameters;
    if (0 === (seen0 & 8))
      $this.r2x_1 = null;
    else
      $this.r2x_1 = publicKey;
    return $this;
  }
  ...
  function UnknownKeyAlgorithmIdentifier(algorithm) {
    this.s2x_1 = algorithm;
  }
  protoOf(UnknownKeyAlgorithmIdentifier).a2x = function () {
    return this.s2x_1;
  };
  protoOf(UnknownKeyAlgorithmIdentifier).t2x = function () {
    return null;
  };
  ...
  protoOf(KeyAlgorithmIdentifierSerializer).v2x = function (_this__u8e3s4, value) {
    var tmp;
    if (value instanceof RsaKeyAlgorithmIdentifier) {
      this.e2x(_this__u8e3s4, NothingSerializer(), RsaKeyAlgorithmIdentifier_instance.t2x());
      tmp = Unit_instance;
    } else {
      if (value instanceof EcKeyAlgorithmIdentifier) {
        var tmp_0 = Companion_instance_0.c1t();
        var tmp_1 = value.h2x_1;
        this.e2x(_this__u8e3s4, tmp_0, tmp_1 == null ? null : new EcParameters(tmp_1));
        tmp = Unit_instance;
      } else {
        if (value instanceof UnknownKeyAlgorithmIdentifier) {
          this.e2x(_this__u8e3s4, NothingSerializer(), value.t2x());
          tmp = Unit_instance;
        } else {
          this.e2x(_this__u8e3s4, NothingSerializer(), null);
          tmp = Unit_instance;
        }
      }
    }
  ...
  protoOf(KeyAlgorithmIdentifierSerializer).c2x = function (_this__u8e3s4, value) {
    return this.v2x(_this__u8e3s4, isInterface(value, KeyAlgorithmIdentifier) ? value : THROW_CCE());
  };
  protoOf(KeyAlgorithmIdentifierSerializer).d2x = function (_this__u8e3s4, algorithm) {
    var tmp;
    if (algorithm === get_RSA(Companion_instance)) {
      this.f2x(_this__u8e3s4, NothingSerializer());
      tmp = RsaKeyAlgorithmIdentifier_instance;
    } else if (algorithm === get_EC(Companion_instance)) {
      var tmp_0 = this.f2x(_this__u8e3s4, Companion_instance_0.c1t());
      tmp = new EcKeyAlgorithmIdentifier(tmp_0 == null ? null : tmp_0.k2x_1);
    } else {
  ...
  function Companion_1() {
    ...
    // Inline function 'kotlin.js.unsafeCast' call
    // Inline function 'kotlin.js.asDynamic' call
    tmp.w2x_1 = [null, new ContextualSerializer(tmp_0, tmp_1, tmp$ret$2), null];
  }
  ...
  function $serializer_1() {
    ...
    tmp0_serialDesc.uy('version', false);
    tmp0_serialDesc.uy('privateKeyAlgorithm', false);
    tmp0_serialDesc.uy('privateKey', false);
    this.x2x_1 = tmp0_serialDesc;
  }
  protoOf($serializer_1).y2x = function (encoder, value) {
    var tmp0_desc = this.x2x_1;
    var tmp1_output = encoder.hr(tmp0_desc);
    var tmp2_cached = Companion_getInstance_1().w2x_1;
    tmp1_output.rs(tmp0_desc, 0, value.z2x_1);
    tmp1_output.ys(tmp0_desc, 1, tmp2_cached[1], value.a2y_1);
    tmp1_output.ys(tmp0_desc, 2, ByteArraySerializer_getInstance(), value.b2y_1);
    tmp1_output.ir(tmp0_desc);
  };
  protoOf($serializer_1).ko = function (encoder, value) {
    return this.y2x(encoder, value instanceof PrivateKeyInfo ? value : THROW_CCE());
  };
  protoOf($serializer_1).lo = function (decoder) {
    var tmp0_desc = this.x2x_1;
    var tmp1_flag = true;
    var tmp2_index = 0;
    var tmp3_bitMask0 = 0;
    ...
    var tmp8_cached = Companion_getInstance_1().w2x_1;
    if (tmp7_input.xr()) {
      tmp4_local0 = tmp7_input.mr(tmp0_desc, 0);
      tmp3_bitMask0 = tmp3_bitMask0 | 1;
      tmp5_local1 = tmp7_input.tr(tmp0_desc, 1, tmp8_cached[1], tmp5_local1);
      tmp3_bitMask0 = tmp3_bitMask0 | 2;
      tmp6_local2 = tmp7_input.tr(tmp0_desc, 2, ByteArraySerializer_getInstance(), tmp6_local2);
      tmp3_bitMask0 = tmp3_bitMask0 | 4;
    } else
      while (tmp1_flag) {
  ...
  protoOf($serializer_1).xn = function () {
    return this.x2x_1;
  };
  protoOf($serializer_1).kz = function () {
    var tmp0_cached = Companion_getInstance_1().w2x_1;
    // Inline function 'kotlin.arrayOf' call
    // Inline function 'kotlin.js.unsafeCast' call
    // Inline function 'kotlin.js.asDynamic' call
  ...
  function PrivateKeyInfo_init_$Init$(seen0, version, privateKeyAlgorithm, privateKey, serializationConstructorMarker, $this) {
    if (!(7 === (7 & seen0))) {
      throwMissingFieldException(seen0, 7, $serializer_getInstance_3().x2x_1);
    }
    $this.z2x_1 = version;
    $this.a2y_1 = privateKeyAlgorithm;
    $this.b2y_1 = privateKey;
    return $this;
  }
  ...
  function Companion_2() {
    ...
    // Inline function 'kotlin.js.unsafeCast' call
    // Inline function 'kotlin.js.asDynamic' call
    tmp.c2y_1 = [new ContextualSerializer(tmp_0, tmp_1, tmp$ret$2), null];
  }
  ...
  function $serializer_2() {
    ...
    tmp0_serialDesc.uy('algorithm', false);
    tmp0_serialDesc.uy('subjectPublicKey', false);
    this.d2y_1 = tmp0_serialDesc;
  }
  protoOf($serializer_2).e2y = function (encoder, value) {
    var tmp0_desc = this.d2y_1;
    var tmp1_output = encoder.hr(tmp0_desc);
    var tmp2_cached = Companion_getInstance_2().c2y_1;
    tmp1_output.ys(tmp0_desc, 0, tmp2_cached[0], value.f2y_1);
    tmp1_output.ys(tmp0_desc, 1, $serializer_getInstance_0(), value.g2y_1);
    tmp1_output.ir(tmp0_desc);
  };
  protoOf($serializer_2).ko = function (encoder, value) {
    return this.e2y(encoder, value instanceof SubjectPublicKeyInfo ? value : THROW_CCE());
  };
  protoOf($serializer_2).lo = function (decoder) {
    var tmp0_desc = this.d2y_1;
    var tmp1_flag = true;
    var tmp2_index = 0;
    var tmp3_bitMask0 = 0;
    ...
    var tmp5_local1 = null;
    var tmp6_input = decoder.hr(tmp0_desc);
    var tmp7_cached = Companion_getInstance_2().c2y_1;
    if (tmp6_input.xr()) {
      tmp4_local0 = tmp6_input.tr(tmp0_desc, 0, tmp7_cached[0], tmp4_local0);
      tmp3_bitMask0 = tmp3_bitMask0 | 1;
      tmp5_local1 = tmp6_input.tr(tmp0_desc, 1, $serializer_getInstance_0(), tmp5_local1);
      tmp3_bitMask0 = tmp3_bitMask0 | 2;
    } else
      while (tmp1_flag) {
        tmp2_index = tmp6_input.yr(tmp0_desc);
        switch (tmp2_index) {
          case -1:
            tmp1_flag = false;
            break;
    ...
    tmp6_input.ir(tmp0_desc);
    return SubjectPublicKeyInfo_init_$Create$(tmp3_bitMask0, tmp4_local0, tmp5_local1, null);
  };
  protoOf($serializer_2).xn = function () {
    return this.d2y_1;
  };
  protoOf($serializer_2).kz = function () {
    // Inline function 'kotlin.arrayOf' call
    // Inline function 'kotlin.js.unsafeCast' call
    // Inline function 'kotlin.js.asDynamic' call
    return [Companion_getInstance_2().c2y_1[0], $serializer_getInstance_0()];
  };
  ...
  function SubjectPublicKeyInfo_init_$Init$(seen0, algorithm, subjectPublicKey, serializationConstructorMarker, $this) {
    if (!(3 === (3 & seen0))) {
      throwMissingFieldException(seen0, 3, $serializer_getInstance_4().d2y_1);
    }
    $this.f2y_1 = algorithm;
    $this.g2y_1 = subjectPublicKey;
    return $this;
  }
  ...
  protoOf(RsaKeyAlgorithmIdentifier).a2x = function () {
    return get_RSA(Companion_instance);
  };
  protoOf(RsaKeyAlgorithmIdentifier).t2x = function () {
    return null;
  };
  ...
  protoOf($serializer_0).lz = typeParametersSerializers;
  protoOf($serializer_1).lz = typeParametersSerializers;
  protoOf($serializer_2).lz = typeParametersSerializers;
  //endregion
  //region block: init
