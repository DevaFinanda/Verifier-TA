 ...
 */
function extractRawPublicKey(spkiHex: string): string {
 ...
 */
export function extractRawPrivateKey(pkcs8Hex: string): Buffer {
 ...
 */
export function saveKeypairToEnv(
  privateKeyHex: string,
  publicKeyHex: string,
  publicKeyMultibase: string
): void {
  ...
  envContent = envContent
    .split('\n')
    .filter(line => 
      !line.startsWith('VERIFIER_PRIVATE_KEY=') && 
 ...
 */
export function createSigner(privateKeyHex: string): (data: string) => Buffer {
